...
>
> -- [GitLab Values: Kindness](https://handbook.gitlab.com/handbook/values/#kindness)
...
- All of this. [GitLab Values: Give Feedback Effectively](https://handbook.gitlab.com/handbook/values/#give-feedback-effectively)
- “Give negative feedback in the smallest setting possible. One-on-one video calls are preferred.” “Negative feedback can be given in a group setting if it’s to someone higher in the management chain. This shows that no one is above feedback.” ([GitHub Values: Negative Feedback is 1x1](https://handbook.gitlab.com/handbook/values/#negative-feedback-is-1-1)). Having been on the receiving end of this, I agree almost entirely with the spirit of this; however, truly egregious behavior, especially by those in higher profile roles, should be called out in the forum where it took place to model for everyone that it is not tolerated.
...
>
> [GitLab Values: Say Sorry](https://handbook.gitlab.com/handbook/values/#say-sorry)
...
> [GitLab Values: Don't let each other fail](https://handbook.gitlab.com/handbook/values/#dont-let-each-other-fail)
